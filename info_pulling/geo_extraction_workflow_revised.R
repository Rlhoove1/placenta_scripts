...
get_gse_metadata <- function(geo_ids) {
  gse_dataframes <- lapply(geo_ids, function(geo_id) {
...
metadata_df$last_update_date <- format( metadata_df$last_update_date, "%m/%d/%Y")
